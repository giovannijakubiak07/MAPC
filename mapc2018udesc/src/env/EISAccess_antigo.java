...
public class EISAccess_antigo extends Artifact implements AgentListener {
	
    private Logger logger = Logger.getLogger("EISAccess." + EISAccess_antigo.class.getName());
