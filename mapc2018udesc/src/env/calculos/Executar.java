...
//		Ponto l = new Ponto( "L", 0, 4 ); lista.add( l );
		...
		Ponto a = new Ponto( "A", 1, 2 ); lista.add( a );
		Ponto b = new Ponto( "B", 1, 1 ); lista.add( b );
		Ponto c = new Ponto( "C", 2, 2 ); lista.add( c );
		Ponto d = new Ponto( "D", 2, 1 ); lista.add( d );
				
		Calculos cal = new Calculos( lista );
		cal.construirPoligono();
		cal.mostrarInformacoes();
		
		System.out.println( cal.calcularPonto( 0, 0 ).toString() );
		System.out.println( cal.calcularPonto( 0, 3 ).toString() );
		System.out.println( cal.calcularPonto( 3, 3 ).toString() );
		System.out.println( cal.calcularPonto( 3, 0 ).toString() );
	}
